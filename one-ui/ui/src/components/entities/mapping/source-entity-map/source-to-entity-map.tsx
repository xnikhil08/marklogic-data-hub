...
import { Modal, Table, Icon, Popover, Input, Button, Alert, message, Tooltip, Spin, Divider, Menu, Dropdown, TreeSelect, Select } from "antd";
            ...
            <div
                ...
                <div className={styles.entityDetails}>
                    ...
                    <span className={styles.btn_icons}>
                        <Button id="Clear-btn" mat-raised-button color="primary" onClick={() => onClear()}>
                            Clear
                    </Button>
                        &nbsp;&nbsp;
                    <Button id="Test-btn" mat-raised-button type="primary" onClick={() => getMapValidationResp(srcURI)}>
                            Test
                    </Button>
                    </span>
                </div>
